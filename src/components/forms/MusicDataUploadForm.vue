    ...
    <div class="card-body">
        ...
        <div class="card-title">
            <div class="flex flex-col xl:flex-row justify-between items-center w-full gap-2">
                <MusicMultiStepForm :sub-mode="subMode" :sub-mode-options="subModeOptions"></MusicMultiStepForm>
            </div>
        </div>
        <ul>
