...
import DualMusicDataUploadForm from '../components/forms/DualMusicDataUploadForm.vue'
const store = useStore()
const title = ref('DualMusic')
const subTitle = ref('雙人音樂')
...
function fetchMusicXML() {
    ...
    axios.post('/dualmusic', payload).then(function (mxl) {
